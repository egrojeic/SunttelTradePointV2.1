...
namespace SunttelTradePointB.Server.Interfaces.CreditBkServices
{
    ...
    public interface ICredit
    {
        ...
        /// <returns></returns>
        Task<(bool IsSuccess, List<CreditDocument>? CreditDocumentsList, string? ErrorDescription)> GetCreditDocuments(string userId, string ipAddress, string squadId, DateTime startDate, DateTime endDate,bool isASale, int? page = 1, int? perPage = 10, string? filter = null);
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        Task<(bool IsSuccess, List<CreditStatus>? CreditStatusesList, string? ErrorDescription)> GetCreditStatuses(string userId, string ipAddress, string squadId, int? page = 1, int? perPage = 10, string? filter = null);
